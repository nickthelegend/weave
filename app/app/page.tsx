...
export default function AppPage() {
            ...
            getUSDCBalance().then(bal => {
                ...
                try {
                    if (typeof window !== 'undefined' && window.localStorage) {
                        dismissed = !!window.localStorage.getItem('weave_faucet_banner_dismissed');
                    }
                } catch (e) {
    ...
    const dismissBanner = () => {
        ...
        try {
            if (typeof window !== 'undefined' && window.localStorage) {
                window.localStorage.setItem('weave_faucet_banner_dismissed', 'true');
            }
        } catch (e) { }
    };
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                ...
                <div className="lg:col-span-5 space-y-8">
                    ...
                    <div className="terminal-card bg-black p-6 space-y-6 border-dashed border-white/10 opacity-60">
                        ...
                        <div className="space-y-6">
                            {harvestHistory.length > 0 ? harvestHistory.map((h: any, i: number) => (
