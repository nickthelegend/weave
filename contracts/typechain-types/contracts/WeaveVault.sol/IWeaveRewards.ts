...
export interface IWeaveRewardsInterface extends Interface {
...
export interface IWeaveRewards extends BaseContract {
  connect(runner?: ContractRunner | null): IWeaveRewards;
  waitForDeployment(): Promise<this>;

  interface: IWeaveRewardsInterface;
